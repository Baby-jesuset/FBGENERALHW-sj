  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Page Header */}
        <div className="py-12 md:py-3.5 bg-background">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl font-bold text-foreground md:text-4xl">Shopping Cart</h1>
          </div>
        </div>
                  ...
                  <CardContent className="p-4">
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-lg font-bold text-foreground mt-2">UGX {item.price.toLocaleString()}</p>
